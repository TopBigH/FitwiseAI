...
DO $$ 
BEGIN
  DROP POLICY IF EXISTS "Users can insert their own workout progress" ON user_workouts;
  DROP POLICY IF EXISTS "Users can view their own workout progress" ON user_workouts;
  DROP POLICY IF EXISTS "Users can update their own workout progress" ON user_workouts;
  DROP POLICY IF EXISTS "Users can insert their own exercise logs" ON user_exercise_logs;
  DROP POLICY IF EXISTS "Users can view their own exercise logs" ON user_exercise_logs;
  DROP POLICY IF EXISTS "Users can update their own exercise logs" ON user_exercise_logs;
END $$;
...
-- Create policies for user_exercise_logs
